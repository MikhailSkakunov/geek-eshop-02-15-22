...
public class CartController {
    ...
    public void deleteLineItemQtr(@RequestBody LineItem lineItem) {
    ProductDto productDto = productService.findById(lineItem.getProductId())
            .orElseThrow(RuntimeException::new);
        cartService.removeProductQty(productDto, lineItem.getColor(), lineItem.getMaterial(), lineItem.getQty());
    }
